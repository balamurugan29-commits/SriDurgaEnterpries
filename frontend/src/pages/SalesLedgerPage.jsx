                            ...
                            >
                              ...
                              <div>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.65rem', marginTop: '1.5rem' }}>
                                  {/* 2. Customer & Statement Meta Info Box (Box 1) */}
                                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', padding: '0.85rem 1.15rem', border: '1.5px solid #000000', borderRadius: '4px', background: '#f8fafc' }}>
                                    <div>
                                      ...
                                      <div style={{ fontSize: '1.3rem', fontWeight: 900, color: '#000000', marginTop: '3px' }}>{cust.customerName}</div>
                                      <div style={{ fontSize: '0.75rem', color: '#64748b', marginTop: '3px' }}>Customer Sl. No: #{pIdx + 1} of {consolidatedCustomers.length}</div>
                                    </div>
                                  ...
                                  <div style={{ border: '1.5px solid #000000', borderRadius: '4px', overflow: 'hidden' }}>
                                    ...
                                    <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.925rem', fontFamily: 'Calibri, "Segoe UI", Arial, sans-serif' }}>
                                      <tbody>
                                        ...
                                        <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
                                          <td style={{ padding: '8px 14px', fontWeight: 700, color: '#475569' }}>Total Sales / Invoices</td>
                                        ...
                                        <tr style={{ borderBottom: '1.5px solid #000000' }}>
                                          <td style={{ padding: '8px 14px', fontWeight: 700, color: '#475569' }}>Total Received Amount</td>
                                  ...
                                  <div style={{ 
                                    ...
                                    <div>
                                      ...
                                      <div style={{ fontSize: '1rem', fontWeight: 800, color: cust.netBalance > 0 ? '#991b1b' : (cust.netBalance < 0 ? '#1e40af' : '#166534'), marginTop: '3px' }}>
                                        {cust.netBalance > 0 
                                    ...
                                    <div style={{ textAlign: 'right' }}>
                                      <div style={{ fontSize: '1.5rem', fontWeight: 900, color: cust.netBalance > 0 ? '#dc2626' : (cust.netBalance < 0 ? '#1e40af' : '#16a34a') }}>
