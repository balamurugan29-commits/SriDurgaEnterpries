                          ...
                          <tbody>
                            ...
                            <tr style={{ borderBottom: '1px solid #000' }}>
                              ...
                              <td style={{ padding: '3.5px 6px', borderRight: '1px solid #000', fontSize: '12px' }}>
                                {challan.contractNo || companyDetails?.contractNo || '9010038288'}
                              </td>
                              <td style={{ padding: '3.5px 6px', fontWeight: 'bold', borderRight: '1px solid #000', fontSize: '12px' }}>
                                Page
                              </td>
                            ...
                            {isFirstPage && (
                              <>
                                ...
                                <tr style={{ borderBottom: '1px solid #000' }}>
                                  ...
                                  <td style={{ padding: '3.5px 6px', borderRight: '1px solid #000', fontSize: '12px' }}>
                                    {challan.contractPeriod || companyDetails?.contractPeriod || '01.05.2024 to 30.04.2027'}
                                  </td>
                                  <td style={{ padding: '3.5px 6px', fontWeight: 'bold', borderRight: '1px solid #000', fontSize: '12px' }}>
                                    Vendor Code
                                  </td>
                                  <td style={{ padding: '3.5px 6px', fontSize: '12px' }}>
                                    {challan.vendorCode || companyDetails?.vendorCode || '840305'}
                                  </td>
                                </tr>
                                ...
                                <tr style={{ borderBottom: '1px solid #000' }}>
                                  ...
                                  <td style={{ padding: '3.5px 6px', borderRight: '1px solid #000', fontSize: '12px' }}>
                                    {challan.bgNo || companyDetails?.bgNo || '8110IPEBG240001  Validity Upto : 30.09.2027'}
                                  </td>
                                  <td style={{ padding: '3.5px 6px', fontWeight: 'bold', borderRight: '1px solid #000', fontSize: '12px' }}>
                                    PAN
                                  </td>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.625rem', flexWrap: 'wrap' }}>
            ...
            <label 
              style={{ 
                ...
                alignItems: 'center', 
                gap: '0.45rem', 
                background: showDeclaration ? 'rgba(16, 185, 129, 0.25)' : 'rgba(30, 41, 59, 0.8)', 
              ...
              title="Toggle to Show or Hide statutory Declaration in Tax Invoice printout"
            >
              <input
                type="checkbox"
