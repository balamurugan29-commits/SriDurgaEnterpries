...
public class ProformaInvoice {
    ...
    @Column(name = "proforma_number", nullable = false, unique = true, length = 50)
    ...
    @OneToMany(mappedBy = "proformaInvoice", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.EAGER)
