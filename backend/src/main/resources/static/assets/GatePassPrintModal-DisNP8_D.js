import{o as e}from"./rolldown-runtime-C0FnF6B9.js";import{t}from"./printer-Bxno3-7W.js";import{N as n,Nt as r,P as i,at as a,j as o,n as s,t as c}from"./index-D6uXCaHg.js";var l=e(r()),u=n(),d=({isOpen:e,onClose:n,gatePass:r})=>{let[d,f]=(0,l.useState)(()=>{let e=localStorage.getItem(`sri_durga_company_details`);if(e)try{return JSON.parse(e)}catch{}return i});if((0,l.useEffect)(()=>{e&&a().then(e=>{e&&f(e)}).catch(e=>console.warn(`Could not load company details for gate pass print`,e))},[e]),(0,l.useEffect)(()=>{let t=e=>{e.key===`Escape`&&n()};return e&&window.addEventListener(`keydown`,t),()=>window.removeEventListener(`keydown`,t)},[e,n]),!e||!r)return null;let p=()=>{let e=document.getElementById(`gatepass-print-area`);if(!e){window.print();return}let t=window.open(``,`_blank`,`width=900,height=1100`);if(t){let n=e.outerHTML;t.document.write(`
        <!DOCTYPE html>
        <html>
          <head>
