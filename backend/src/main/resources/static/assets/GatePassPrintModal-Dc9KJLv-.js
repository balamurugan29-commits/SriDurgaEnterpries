import{o as e}from"./rolldown-runtime-C0FnF6B9.js";import{t}from"./printer-Cjkknq3O.js";import{F as n,M as r,P as i,Pt as a,n as o,ot as s,t as c}from"./index-DAXh9F0c.js";var l=e(a()),u=i(),d=({isOpen:e,onClose:i,gatePass:a})=>{let[d,f]=(0,l.useState)(()=>{let e=localStorage.getItem(`sri_durga_company_details`);if(e)try{return JSON.parse(e)}catch{}return n});if((0,l.useEffect)(()=>{e&&s().then(e=>{e&&f(e)}).catch(e=>console.warn(`Could not load company details for gate pass print`,e))},[e]),(0,l.useEffect)(()=>{let t=e=>{e.key===`Escape`&&i()};return e&&window.addEventListener(`keydown`,t),()=>window.removeEventListener(`keydown`,t)},[e,i]),!e||!a)return null;let p=()=>{let e=document.getElementById(`gatepass-print-area`);if(!e){window.print();return}let t=window.open(``,`_blank`,`width=900,height=1100`);if(t){let n=e.outerHTML;t.document.write(`
        <!DOCTYPE html>
        <html>
          <head>
