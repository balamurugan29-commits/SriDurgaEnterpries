import{o as e}from"./rolldown-runtime-C0FnF6B9.js";import{t}from"./file-text-KYWHm0x5.js";import{t as n}from"./printer-BOyVrnzR.js";import{P as r,Pt as i,n as a}from"./index-B8WFiSx3.js";var o=e(i()),s=r(),c=({isOpen:e,onClose:r,certificate:i})=>{let[c,l]=(0,o.useState)(`both`);if((0,o.useEffect)(()=>{let t=e=>{e.key===`Escape`&&r()};return e&&window.addEventListener(`keydown`,t),()=>window.removeEventListener(`keydown`,t)},[e,r]),!e||!i)return null;let u=e=>{if(!e)return!1;let t=(e.rcItemNo||``).toString().trim(),n=(e.description||``).toString().trim();return t!==``&&t!==`-`||n!==``&&n!==`-`},d=(i.items||[]).filter(e=>(e.itemType===`SERVICE`||e.itemType===`Service`)&&u(e)),f=(i.items||[]).filter(e=>(e.itemType===`MATERIAL`||e.itemType===`Material`||!e.itemType)&&u(e)),p=d.length>0,m=f.length>0,h=()=>{let e=document.getElementById(`work-cert-print-area`);if(!e){window.print();return}let t=window.open(``,`_blank`,`width=900,height=1050`);if(t){let n=e.innerHTML;t.document.write(`
        <!DOCTYPE html>
        <html>
          <head>
