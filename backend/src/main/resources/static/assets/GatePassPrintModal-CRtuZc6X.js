import{o as e}from"./rolldown-runtime-C0FnF6B9.js";import{$t as t,M as n,Zt as r,ln as i,n as a}from"./vendor-react-CO5jE0kK.js";import{M as o,n as s,t as c}from"./index-BvXPEMFi.js";var l=e(i()),u=t(),d=({isOpen:e,onClose:t,gatePass:i})=>{let[d,f]=(0,l.useState)(()=>{let e=localStorage.getItem(`sri_durga_company_details`);if(e)try{return JSON.parse(e)}catch{}return s});if((0,l.useEffect)(()=>{e&&o().then(e=>{e&&f(e)}).catch(e=>console.warn(`Could not load company details for gate pass print`,e))},[e]),(0,l.useEffect)(()=>{let n=e=>{e.key===`Escape`&&t()};return e&&window.addEventListener(`keydown`,n),()=>window.removeEventListener(`keydown`,n)},[e,t]),!e||!i)return null;let p=()=>{let e=document.getElementById(`gatepass-print-area`);if(!e){window.print();return}let t=window.open(``,`_blank`,`width=900,height=1100`);if(t){let n=e.outerHTML;t.document.write(`
        <!DOCTYPE html>
        <html>
          <head>
            <title>Gate Pass - ${i.gatePassNo||`Delivery Challan`}</title>
            <style>
              * {
                margin: 0;
                padding: 0;
