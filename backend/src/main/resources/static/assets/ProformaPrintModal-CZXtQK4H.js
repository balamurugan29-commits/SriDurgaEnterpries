import{o as e}from"./rolldown-runtime-C0FnF6B9.js";import{n as t}from"./Toast-2yhZI8tS.js";import{t as n}from"./printer-NLTCPpnw.js";import{N as r,Nt as i,P as a,at as o,n as s,t as c}from"./index-Dv2XbRre.js";function l(e){let t=Math.round(Number(e)||0);if(t===0)return`Zero Only`;let n=[``,`One `,`Two `,`Three `,`Four `,`Five `,`Six `,`Seven `,`Eight `,`Nine `,`Ten `,`Eleven `,`Twelve `,`Thirteen `,`Fourteen `,`Fifteen `,`Sixteen `,`Seventeen `,`Eighteen `,`Nineteen `],r=[``,``,`Twenty `,`Thirty `,`Forty `,`Fifty `,`Sixty `,`Seventy `,`Eighty `,`Ninety `],i=(e=>{let t=``,i=(`000000000`+e).slice(-9),a=parseInt(i.substring(0,2),10),o=parseInt(i.substring(2,4),10),s=parseInt(i.substring(4,6),10),c=parseInt(i.substring(6,7),10),l=parseInt(i.substring(7,9),10);return a>0&&(t+=(n[a]||r[Math.floor(a/10)]+n[a%10])+`Crore `),o>0&&(t+=(n[o]||r[Math.floor(o/10)]+n[o%10])+`Lakhs `),s>0&&(t+=(n[s]||r[Math.floor(s/10)]+n[s%10])+`Thousand `),c>0&&(t+=n[c]+`Hundred `),l>0&&(t!==``&&(t+=`and `),t+=n[l]||r[Math.floor(l/10)]+n[l%10]),t})(t).trim();return i?`(Rupees : ${i} Only)`:`(Rupees : Zero Only)`}function u(e){if(!e)return``;let t=e.proformaNumber||`PC/01/26-27`,n=`31-12-2025`;if(e.proformaDate){let t=new Date(e.proformaDate);isNaN(t.getTime())||(n=`${String(t.getDate()).padStart(2,`0`)}-${String(t.getMonth()+1).padStart(2,`0`)}-${t.getFullYear()}`)}let r=(Array.isArray(e.items)?e.items:[]).filter(e=>e.itemCode&&e.itemCode.trim()||e.description&&e.description.trim()||Number(e.rate)>0),i=r.reduce((e,t)=>e+(Number(t.amount)||(Number(t.quantity)||1)*(Number(t.rate)||0)),0),a=Number(e.gstPercent)!==void 0&&!isNaN(Number(e.gstPercent))?Number(e.gstPercent):18,o=(e.customerGstin||``).trim().substring(0,2),s=!o||o===`34`||e.customerStateCode&&(e.customerStateCode.toLowerCase().includes(`puducherry`)||e.customerStateCode.includes(`34`)),u=i*a/100,d=i+u,f=e.contractNo||e.poNumber||`9010038288`,p=e.contractPeriod||`01.05.2024 to 30.04.2027`,m=e.vendorCode||`840305`,h=e.poNumber||`5060173862`,g=e.bgNo||`8110IPEBG240001  Validity Upto : 30.09.2027`,_=e.gstin||`34ABDFS4476N1ZN`,v=e.pan||`ABDFS4476N`,y=e.epfCode||`PC 1758`,b=e.esiCode||`55000426770000602`,x=e.stateCode||`Puducherry (34)`,S=e.sacCode||`995469`,C=e.customerName||`The G.M (Electrical), Surface Team , ONGC, Tamilnadu.`,w=e.customerPan||`AAACO1598A`,T=e.customerGstin||`33AAACO1598A1ZU`,E=e.customerStateCode||`TAMILNADU (33)`,D=[];if(r.length<=22)D.push({pageNum:1,totalPages:1,items:r,isFirst:!0,isLast:!0,startIdx:0});else{let e=0,t=1,n=r.slice(0,28);for(e+=n.length,D.push({pageNum:1,items:n,isFirst:!0,isLast:e>=r.length,startIdx:0});e<r.length;){t++;let n=r.slice(e,e+26);e+=n.length,D.push({pageNum:t,items:n,isFirst:!1,isLast:e>=r.length,startIdx:e-n.length})}let i=D.length;D.forEach(e=>{e.totalPages=i})}let O=[],k=0;D.forEach((e,t)=>{let n=e.items.reduce((e,t)=>e+(Number(t.amount)||(Number(t.quantity)||1)*(Number(t.rate)||0)),0);k+=n,O.push(k)});let A=l(d);return`
    <!DOCTYPE html>
    <html>
    <head>
      <meta charset="utf-8">
    ...
    <body>
      ${D.map((r,o)=>{let l=r.pageNum===1,D=r.pageNum===r.totalPages,k=O[o],j=o>0?O[o-1]:0;return`
      <div class="invoice-page ${o>0?`page-break`:``}">
            ...
            <tbody>
              ...
              ${l?`
                ...
                <tr>
                  ...
                  <td style="font-weight: 800;">Rs. ${Math.round(d)}.00</td>
                </tr>
                <tr class="meta-row-billed" style="background-color: #dbe2ea !important;">
                  ...
                  <td style="font-weight: 800; vertical-align: top; background-color: #dbe2ea !important;">${w}</td>
                </tr>
                <tr class="meta-row-billed" style="background-color: #dbe2ea !important;">
                  <td style="font-weight: 800; background-color: #dbe2ea !important;">GST</td>
                  <td style="font-weight: 800; background-color: #dbe2ea !important;">${T}</td>
                  <td style="font-weight: 800; background-color: #dbe2ea !important;">State Code</td>
                  <td style="font-weight: 800; background-color: #dbe2ea !important;">${E}</td>
                </tr>
              `:``}
            </tbody>
          </table>
          ...
          ${D?`
            ...
            <table class="totals-table">
              <tbody>
                ...
                ${s?`
                  <tr>
                    <td style="border-right: 1px solid #000;">SAC CODE : ${S} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; CGST &nbsp;&nbsp;&nbsp;&nbsp; ${(a/2).toFixed(1)}%</td>
                    <td style="text-align: right;">${(u/2).toFixed(2)}</td>
                  </tr>
                  <tr>
                ...
                `:`
                  <tr>
                    <td style="border-right: 1px solid #000;">SAC CODE : ${S} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; IGST &nbsp;&nbsp;&nbsp;&nbsp; ${a}%</td>
                ...
                <tr class="gross-total-row">
                  ...
                  <td style="text-align: right; font-weight: 900; font-size: 13.5px;">${d.toFixed(2)}</td>
                </tr>
                <tr class="rupees-words-row">
                  <td colspan="2" style="font-weight: 800; padding: 4px 6px;">${A}</td>
                </tr>
  ...
  `}function d(e){let t=u(e),n=window.open(``,`_blank`,`width=900,height=1000`);n&&(n.document.open(),n.document.write(t),n.document.close(),n.focus(),setTimeout(()=>{n.print()},400))}var f=e(i()),p=r();function m(e){let t=Math.round(Number(e)||0);if(t===0)return`Zero Only`;let n=[``,`One `,`Two `,`Three `,`Four `,`Five `,`Six `,`Seven `,`Eight `,`Nine `,`Ten `,`Eleven `,`Twelve `,`Thirteen `,`Fourteen `,`Fifteen `,`Sixteen `,`Seventeen `,`Eighteen `,`Nineteen `],r=[``,``,`Twenty`,`Thirty`,`Forty`,`Fifty`,`Sixty`,`Seventy`,`Eighty`,`Ninety`],i=(e=>{let t=``,i=(`000000000`+e).slice(-9),a=parseInt(i.substring(0,2),10),o=parseInt(i.substring(2,4),10),s=parseInt(i.substring(4,6),10),c=parseInt(i.substring(6,7),10),l=parseInt(i.substring(7,9),10);return a>0&&(t+=(n[a]||r[Math.floor(a/10)]+` `+n[a%10])+`Crore `),o>0&&(t+=(n[o]||r[Math.floor(o/10)]+` `+n[o%10])+`Lakh `),s>0&&(t+=(n[s]||r[Math.floor(s/10)]+` `+n[s%10])+`Thousand `),c>0&&(t+=n[c]+`Hundred `),l>0&&(t!==``&&(t+=`and `),t+=n[l]||r[Math.floor(l/10)]+` `+n[l%10]),t})(t).trim();return i?`(Rupees :${i} Only)`:`(Rupees :Zero Only)`}var h=({isOpen:e,onClose:r,proforma:i})=>{let[l,u]=(0,f.useState)(`ORIGINAL`),[d,h]=(0,f.useState)(()=>{let e=localStorage.getItem(`sri_durga_print_show_item_number`);return e===null||e===`true`}),[g,_]=(0,f.useState)(()=>{let e=localStorage.getItem(`sri_durga_company_details`);if(e)try{return JSON.parse(e)}catch{}return a});if((0,f.useEffect)(()=>{e&&o().then(e=>{e&&_(e)}).catch(e=>console.warn(`Could not load company details for print`,e))},[e]),(0,f.useEffect)(()=>{let t=e=>{e.key===`Escape`&&r()};return e&&window.addEventListener(`keydown`,t),()=>window.removeEventListener(`keydown`,t)},[e,r]),!e||!i)return null;let v=()=>{let e=document.getElementById(`proforma-invoice-print-area`);if(!e){window.print();return}let t=window.open(``,`_blank`,`width=900,height=1000`);if(t){let n=e.outerHTML;t.document.write(`
        <!DOCTYPE html>
        <html>
          <head>
      ...
      `),t.document.close()}else window.print()},y=i.proformaNumber||`PC/01/26-27`,b=i.proformaDate?new Date(i.proformaDate).toLocaleDateString(`en-GB`):new Date().toLocaleDateString(`en-GB`),x=i.items||[],S=x.reduce((e,t)=>e+(Number(t.amount)||Number(t.quantity||0)*Number(t.rate||0)),0),C=Number(i.gstPercent===void 0?18:i.gstPercent),w=C/2,T=(i.customerGstin||``).trim().substring(0,2),E=T===`34`||T===``,D=0,O=0,k=0;E?(D=w/100*S,O=w/100*S,k=0):(D=0,O=0,k=C/100*S);let A=S+D+O+k,j=m(A),M=d,N=(e=>{let t=[],n=[...e];if(n.length<=16)return t.push(n),t;for(t.push(n.slice(0,22)),n=n.slice(22);n.length>0;)t.push(n.slice(0,22)),n=n.slice(22);return t})(x),P=e=>{if(e===0)return 0;let t=0;for(let n=0;n<e;n++)for(let e of N[n])t+=Number(e.amount)||Number(e.quantity||0)*Number(e.rate||0);return t},F=e=>N[e].reduce((e,t)=>e+(Number(t.amount)||Number(t.quantity||0)*Number(t.rate||0)),0),I=l===`ALL`?[`ORIGINAL`,`DUPLICATE`,`OFFICE COPY`]:[(e=>e===`ORIGINAL`?`ORIGINAL`:e===`DUPLICATE`?`DUPLICATE`:e===`OFFICE COPY`?`OFFICE COPY`:e)(l)];return(0,p.jsxs)(`div`,{className:`no-print-modal-overlay`,style:{position:`fixed`,inset:0,zIndex:999999,background:`rgba(0, 0, 0, 0.85)`,backdropFilter:`blur(10px)`,display:`flex`,alignItems:`center`,justifyContent:`center`,padding:`0.75rem`,overflow:`hidden`},onClick:e=>{e.target===e.currentTarget&&r()},children:[(0,p.jsx)(`style`,{children:`
        @media print {
          body * {
      ...
      `}),(0,p.jsxs)(`div`,{className:`glass-panel-print-wrap`,style:{width:`100%`,maxWidth:`920px`,height:`95vh`,display:`flex`,flexDirection:`column`,background:`#0f172a`,border:`1.5px solid rgba(56, 189, 248, 0.4)`,borderRadius:`16px`,boxShadow:`0 25px 60px rgba(0, 0, 0, 0.65)`,overflow:`hidden`,position:`relative`},children:[(0,p.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`space-between`,padding:`0.75rem 1.25rem`,background:`rgba(30, 41, 59, 0.98)`,borderBottom:`1px solid rgba(255, 255, 255, 0.1)`,flexShrink:0},children:[(0,p.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`0.625rem`},children:[(0,p.jsx)(`div`,{style:{width:`32px`,height:`32px`,borderRadius:`8px`,background:`rgba(56, 189, 248, 0.18)`,display:`flex`,alignItems:`center`,justifyContent:`center`},children:(0,p.jsx)(t,{size:18,color:`#38bdf8`})}),(0,p.jsxs)(`div`,{children:[(0,p.jsxs)(`h3`,{style:{fontSize:`0.95rem`,fontWeight:800,color:`#f8fafc`,margin:0,lineHeight:1.2},children:[`Proforma Invoice Preview & Print (`,N.length,` `,N.length>1?`Pages`:`Page`,`)`]}),(0,p.jsxs)(`span`,{style:{fontSize:`0.75rem`,color:`#94a3b8`},children:[`Invoice No: `,(0,p.jsx)(`strong`,{style:{color:`#38bdf8`},children:y}),` • Total Items: `,(0,p.jsx)(`strong`,{style:{color:`#34d399`},children:x.length})]})]})]}),(0,p.jsx)(`button`,{onClick:r,className:`btn btn-outline`,style:{width:`36px`,height:`36px`,borderRadius:`50%`,padding:0,display:`flex`,alignItems:`center`,justifyContent:`center`,borderColor:`rgba(255, 255, 255, 0.2)`,background:`rgba(255, 255, 255, 0.06)`,color:`#f8fafc`,cursor:`pointer`,transition:`all 0.2s ease`},title:`Close Preview (Esc)`,"aria-label":`Close Preview`,children:(0,p.jsx)(s,{size:18})})]}),(0,p.jsx)(`div`,{style:{flex:1,padding:`1.5rem`,overflowY:`auto`,background:`#334155`,display:`flex`,justifyContent:`center`,alignItems:`flex-start`},children:(0,p.jsx)(`div`,{id:`proforma-invoice-print-area`,style:{background:`#fff`,width:`100%`,maxWidth:`820px`,boxShadow:`0 8px 30px rgba(0, 0, 0, 0.35)`},children:I.map((e,t)=>(0,p.jsx)(f.Fragment,{children:N.map((n,r)=>{let a=r===0,o=r===N.length-1,s=P(r),l=F(r);return(0,p.jsxs)(`div`,{className:`invoice-page`,style:{border:`2px solid #000000`,padding:`0`,marginBottom:t===I.length-1&&r===N.length-1?`0`:`25px`,background:`#ffffff`,color:`#000000`,boxSizing:`border-box`,width:`100%`,height:`285mm`,minHeight:`285mm`,display:`flex`,flexDirection:`column`,justifyContent:`space-between`,overflow:`hidden`,fontSize:`12px`,fontFamily:`Arial, sans-serif`},children:[(0,p.jsxs)(`div`,{style:{flexShrink:0},children:[(0,p.jsxs)(`div`,{style:{display:`flex`,borderBottom:`1px solid #000`,position:`relative`},children:[(0,p.jsx)(`div`,{style:{width:`85px`,minWidth:`85px`,borderRight:`1px solid #000`,padding:`4px`,display:`flex`,alignItems:`center`,justifyContent:`center`},children:(0,p.jsx)(`img`,{src:c,alt:`Logo`,style:{width:`70px`,height:`70px`,objectFit:`contain`}})}),(0,p.jsxs)(`div`,{style:{flex:1,padding:`4px 8px`,textAlign:`center`},children:[(0,p.jsx)(`div`,{style:{fontSize:`13px`,fontWeight:`bold`,textDecoration:`underline`,letterSpacing:`1px`,marginBottom:`2px`},children:`PROFORMA INVOICE`}),(0,p.jsx)(`h1`,{style:{fontSize:`19px`,fontWeight:`900`,margin:`2px 0`,letterSpacing:`3px`,fontFamily:`Arial, sans-serif`},children:`SRI \xA0 DURGA \xA0 ENTERPRISES`}),(0,p.jsx)(`p`,{style:{margin:`1px 0`,fontSize:`12px`,fontWeight:`600`},children:`No. 10 V.G. Nagar, Kovilpathu, Karaikal – 609 602`}),a&&(0,p.jsx)(`p`,{style:{margin:`1px 0`,fontSize:`12px`,fontWeight:`600`},children:`E-mail : sridurgaenterprises@yahoo.com \xA0\xA0 Cell: 9842492946`})]}),(0,p.jsx)(`div`,{style:{position:`absolute`,right:`10px`,top:`6px`,fontWeight:`bold`,fontSize:`12px`,textTransform:`uppercase`,letterSpacing:`0.5px`},children:e})]}),(0,p.jsx)(`table`,{style:{width:`100%`,borderCollapse:`collapse`,fontSize:`12px`,margin:0,borderBottom:`1px solid #000`},children:(0,p.jsxs)(`tbody`,{children:[(0,p.jsxs)(`tr`,{style:{background:`#dbe2ea`,borderBottom:`1px solid #000`},children:[(0,p.jsx)(`td`,{style:{width:`15%`,padding:`4px 6px`,fontWeight:`bold`,borderRight:`1px solid #000`,fontSize:`12px`},children:`Invoice No.`}),(0,p.jsx)(`td`,{style:{width:`45%`,padding:`4px 6px`,fontWeight:`900`,fontSize:`12.5px`,borderRight:`1px solid #000`},children:y}),(0,p.jsx)(`td`,{style:{width:`15%`,padding:`4px 6px`,fontWeight:`bold`,borderRight:`1px solid #000`,fontSize:`12px`},children:`Date :`}),(0,p.jsx)(`td`,{style:{width:`25%`,padding:`4px 6px`,fontWeight:`900`,fontSize:`12.5px`},children:b})]}),(0,p.jsxs)(`tr`,{style:{borderBottom:`1px solid #000`},children:[(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,borderRight:`1px solid #000`,fontSize:`12px`},children:`Contract No.`}),(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,borderRight:`1px solid #000`,fontSize:`12px`},children:i.contractNo||g?.contractNo||`9010038288`}),(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,borderRight:`1px solid #000`,fontSize:`12px`},children:`Page`}),(0,p.jsxs)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,fontSize:`12px`},children:[r+1,` of `,N.length]})]}),a&&(0,p.jsxs)(p.Fragment,{children:[(0,p.jsxs)(`tr`,{style:{borderBottom:`1px solid #000`},children:[(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,borderRight:`1px solid #000`,fontSize:`12px`},children:`Contract Period (C. Period)`}),(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,borderRight:`1px solid #000`,fontSize:`12px`},children:i.contractPeriod||g?.contractPeriod||`01.05.2024 to 30.04.2027`}),(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,borderRight:`1px solid #000`,fontSize:`12px`},children:`Vendor Code`}),(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,fontSize:`12px`},children:i.vendorCode||g?.vendorCode||`840305`})]}),(0,p.jsxs)(`tr`,{style:{borderBottom:`1px solid #000`},children:[(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,borderRight:`1px solid #000`,fontSize:`12px`},children:`P.O. No.`}),(0,p.jsxs)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,borderRight:`1px solid #000`,fontSize:`12px`},children:[i.poNumber||`5060173862`,` `,i.poDate?`Dt: ${new Date(i.poDate).toLocaleDateString(`en-GB`)}`:``]}),(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,borderRight:`1px solid #000`,fontSize:`12px`},children:`GSTIN`}),(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,fontSize:`12px`},children:g?.gstin||i.gstin||`34ABDFS4476N1ZN`})]}),(0,p.jsxs)(`tr`,{style:{borderBottom:`1px solid #000`},children:[(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,borderRight:`1px solid #000`,fontSize:`12px`},children:`B.G. Number & Validity`}),(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,borderRight:`1px solid #000`,fontSize:`12px`},children:i.bgNo||g?.bgNo||`8110IPEBG240001  Validity Upto : 30.09.2027`}),(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,borderRight:`1px solid #000`,fontSize:`12px`},children:`PAN`}),(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,fontSize:`12px`},children:g?.pan||i.pan||`ABDFS4476N`})]}),(0,p.jsxs)(`tr`,{style:{borderBottom:`1px solid #000`},children:[(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,borderRight:`1px solid #000`,fontSize:`12px`},children:`EPF Code`}),(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,borderRight:`1px solid #000`,fontSize:`12px`},children:g?.epfCode||i.epfCode||`PC 1758`}),(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,borderRight:`1px solid #000`,fontSize:`12px`},children:`State Code`}),(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,fontSize:`12px`},children:g?.state||i.stateCode||`Puducherry (34)`})]}),(0,p.jsxs)(`tr`,{style:{borderBottom:`1px solid #000`},children:[(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,borderRight:`1px solid #000`,fontSize:`12px`},children:`ESI CODE`}),(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,borderRight:`1px solid #000`,fontSize:`12px`},children:g?.esiCode||i.esiCode||`55000426770000602`}),(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,borderRight:`1px solid #000`,fontSize:`12px`},children:`Invoice Value`}),(0,p.jsxs)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,fontSize:`12px`},children:[`Rs. `,A.toLocaleString(`en-IN`,{minimumFractionDigits:2,maximumFractionDigits:2})]})]}),(0,p.jsxs)(`tr`,{style:{background:`#dbe2ea`,borderBottom:`1px solid #000`},children:[(0,p.jsx)(`td`,{style:{padding:`4px 6px`,fontWeight:`bold`,background:`#dbe2ea`,verticalAlign:`top`,borderRight:`1px solid #000`,fontSize:`12px`},children:`BILLED TO`}),(0,p.jsxs)(`td`,{style:{padding:`4px 6px`,fontWeight:`bold`,background:`#dbe2ea`,lineHeight:`1.35`,borderRight:`1px solid #000`,fontSize:`12px`},children:[(0,p.jsx)(`div`,{style:{fontWeight:`bold`},children:i.customerName||`-`}),i.customerAddress&&(0,p.jsx)(`div`,{style:{fontWeight:`normal`,fontSize:`11px`,whiteSpace:`pre-line`},children:i.customerAddress}),i.customerPhone&&(0,p.jsxs)(`div`,{style:{fontWeight:`normal`,fontSize:`11px`},children:[`Phone: `,i.customerPhone]})]}),(0,p.jsx)(`td`,{style:{padding:`4px 6px`,fontWeight:`bold`,background:`#dbe2ea`,verticalAlign:`top`,borderRight:`1px solid #000`,fontSize:`12px`},children:`PAN`}),(0,p.jsx)(`td`,{style:{padding:`4px 6px`,fontWeight:`bold`,background:`#dbe2ea`,verticalAlign:`top`,fontSize:`12px`},children:i.customerPan||`-`})]}),(0,p.jsxs)(`tr`,{style:{background:`#dbe2ea`,borderBottom:`1px solid #000`},children:[(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,background:`#dbe2ea`,borderRight:`1px solid #000`,fontSize:`12px`},children:`GST`}),(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,background:`#dbe2ea`,borderRight:`1px solid #000`,fontSize:`12px`},children:i.customerGstin||`-`}),(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,background:`#dbe2ea`,borderRight:`1px solid #000`,fontSize:`12px`},children:`State Code`}),(0,p.jsx)(`td`,{style:{padding:`3.5px 6px`,fontWeight:`bold`,background:`#dbe2ea`,fontSize:`12px`},children:i.customerStateCode||`TAMILNADU (33)`})]})]})]})}),i.equipmentHeader&&a&&(0,p.jsx)(`div`,{style:{borderBottom:`1px solid #000`,padding:`0.35rem 0.75rem`,background:`#f8fafc`,fontWeight:`bold`,fontSize:`12px`,textAlign:`center`},children:i.equipmentHeader})]}),(0,p.jsx)(`div`,{style:{flex:1,display:`flex`,flexDirection:`column`,minHeight:0},children:(0,p.jsxs)(`table`,{style:{width:`100%`,height:`100%`,borderCollapse:`collapse`,fontSize:`12px`,textAlign:`left`,margin:0,display:`table`},children:[(0,p.jsx)(`thead`,{children:(0,p.jsxs)(`tr`,{style:{borderBottom:`1.5px solid #000`,background:`#f1f5f9`,fontWeight:`bold`,textAlign:`center`,height:`28px`},children:[(0,p.jsx)(`th`,{style:{width:`42px`,padding:`4px 2px`,borderRight:`1px solid #000`,fontSize:`12px`},children:`Sl.No.`}),M&&(0,p.jsx)(`th`,{style:{width:`80px`,padding:`4px 2px`,borderRight:`1px solid #000`,fontSize:`12px`},children:`Item No.`}),(0,p.jsx)(`th`,{style:{padding:`4px 6px`,borderRight:`1px solid #000`,textAlign:`center`,fontSize:`12px`},children:`Description`}),(0,p.jsx)(`th`,{style:{width:`85px`,padding:`4px 4px`,borderRight:`1px solid #000`,textAlign:`center`,fontSize:`12px`},children:`Rate`}),(0,p.jsx)(`th`,{style:{width:`60px`,padding:`4px 2px`,borderRight:`1px solid #000`,textAlign:`center`,fontSize:`12px`},children:`Qty`}),(0,p.jsx)(`th`,{style:{width:`105px`,padding:`4px 6px`,textAlign:`center`,fontSize:`12px`},children:`Amount`})]})}),(0,p.jsxs)(`tbody`,{children:[!a&&(0,p.jsxs)(`tr`,{style:{borderBottom:`1px solid #000`,background:`#f8fafc`,height:`26px`},children:[(0,p.jsx)(`td`,{style:{borderRight:`1px solid #000`}}),M&&(0,p.jsx)(`td`,{style:{borderRight:`1px solid #000`}}),(0,p.jsxs)(`td`,{style:{padding:`4px 6px`,textAlign:`center`,borderRight:`1px solid #000`,fontStyle:`italic`,fontWeight:800,fontSize:`12px`},children:[`Brought Forward from Page `,r]}),(0,p.jsx)(`td`,{style:{borderRight:`1px solid #000`}}),(0,p.jsx)(`td`,{style:{borderRight:`1px solid #000`}}),(0,p.jsx)(`td`,{style:{padding:`4px 6px`,textAlign:`right`,fontWeight:800,fontSize:`12px`},children:s.toLocaleString(`en-IN`,{minimumFractionDigits:2,maximumFractionDigits:2})})]}),n.map((e,t)=>{let n=Number(e.quantity)||1,i=Number(e.rate)||0,a=Number(e.amount)||n*i,o=r===0?t+1:N.slice(0,r).reduce((e,t)=>e+t.length,0)+t+1;return(0,p.jsxs)(`tr`,{style:{verticalAlign:`top`,minHeight:`24px`},children:[(0,p.jsx)(`td`,{style:{padding:`4px 2px`,borderRight:`1px solid #000`,textAlign:`center`,fontSize:`12px`},children:e.serialNumber||o}),M&&(0,p.jsx)(`td`,{style:{padding:`4px 2px`,borderRight:`1px solid #000`,textAlign:`center`,fontSize:`12px`,fontWeight:`600`},children:e.itemCode&&e.itemCode.toUpperCase()!==`CUSTOM`?e.itemCode:`-`}),(0,p.jsx)(`td`,{style:{padding:`4px 6px`,borderRight:`1px solid #000`,textAlign:`left`,fontSize:`12px`,whiteSpace:`pre-line`,lineHeight:`1.35`},children:e.description}),(0,p.jsx)(`td`,{style:{padding:`4px 4px`,borderRight:`1px solid #000`,textAlign:`right`,fontSize:`12px`},children:Number(i).toLocaleString(`en-IN`,{minimumFractionDigits:2,maximumFractionDigits:2})}),(0,p.jsxs)(`td`,{style:{padding:`4px 2px`,borderRight:`1px solid #000`,textAlign:`center`,fontSize:`12px`,fontWeight:`600`},children:[n,` `,e.unit||(Number(n)===1?`No`:`Nos`)]}),(0,p.jsx)(`td`,{style:{padding:`4px 6px`,textAlign:`right`,fontSize:`12px`,fontWeight:`600`},children:a.toLocaleString(`en-IN`,{minimumFractionDigits:2,maximumFractionDigits:2})})]},t)}),(0,p.jsxs)(`tr`,{style:{height:`100%`},children:[(0,p.jsx)(`td`,{style:{borderRight:`1px solid #000`},children:`\xA0`}),M&&(0,p.jsx)(`td`,{style:{borderRight:`1px solid #000`},children:`\xA0`}),(0,p.jsx)(`td`,{style:{borderRight:`1px solid #000`},children:`\xA0`}),(0,p.jsx)(`td`,{style:{borderRight:`1px solid #000`},children:`\xA0`}),(0,p.jsx)(`td`,{style:{borderRight:`1px solid #000`},children:`\xA0`}),(0,p.jsx)(`td`,{children:`\xA0`})]}),r<N.length-1&&(0,p.jsxs)(`tr`,{style:{fontWeight:`bold`,background:`#f8fafc`,borderTop:`1.5px solid #000`,height:`30px`},children:[(0,p.jsx)(`td`,{style:{borderRight:`1px solid #000`}}),M&&(0,p.jsx)(`td`,{style:{borderRight:`1px solid #000`}}),(0,p.jsxs)(`td`,{style:{padding:`5px 8px`,textAlign:`center`,borderRight:`1px solid #000`,fontSize:`12px`,fontStyle:`italic`},children:[`Carried Over to Page `,r+2]}),(0,p.jsx)(`td`,{style:{borderRight:`1px solid #000`}}),(0,p.jsx)(`td`,{style:{borderRight:`1px solid #000`}}),(0,p.jsx)(`td`,{style:{padding:`5px 8px`,textAlign:`right`,fontSize:`12px`,fontWeight:800},children:(s+l).toLocaleString(`en-IN`,{minimumFractionDigits:2,maximumFractionDigits:2})})]}),o&&(0,p.jsxs)(`tr`,{style:{borderTop:`1.5px solid #000`,height:`28px`},children:[(0,p.jsx)(`td`,{colSpan:M?5:4,style:{padding:`4px 12px`,textAlign:`right`,fontStyle:`italic`,fontWeight:`bold`,borderRight:`1px solid #000`,fontSize:`12px`},children:`Total`}),(0,p.jsx)(`td`,{style:{padding:`4px 6px`,textAlign:`right`,fontWeight:`bold`,fontSize:`12px`},children:S.toLocaleString(`en-IN`,{minimumFractionDigits:2,maximumFractionDigits:2})})]})]})]})}),o&&(0,p.jsxs)(`div`,{style:{flexShrink:0,borderTop:`1.5px solid #000`},children:[(0,p.jsxs)(`div`,{style:{borderBottom:`1px solid #000`,display:`flex`,fontSize:`12px`},children:[(0,p.jsxs)(`div`,{style:{flex:1,borderRight:`1px solid #000`,padding:`4px 8px`,display:`flex`,flexDirection:`column`,justifyContent:`space-between`},children:[(0,p.jsxs)(`div`,{style:{fontWeight:`bold`,fontSize:`12px`},children:[`SAC Code : `,i.sacCode||`995464`,`, GST : `,C,`%`]}),(0,p.jsx)(`div`,{style:{fontStyle:`italic`,fontWeight:`bold`,fontSize:`11.5px`,marginTop:`6px`},children:j})]}),(0,p.jsxs)(`div`,{style:{width:`255px`,display:`flex`,flexDirection:`column`},children:[E?(0,p.jsxs)(p.Fragment,{children:[(0,p.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,padding:`3px 8px`,borderBottom:`1px solid #000`,fontStyle:`italic`,fontSize:`12px`},children:[(0,p.jsxs)(`span`,{children:[`CGST @ `,w,`%`]}),(0,p.jsx)(`span`,{style:{fontWeight:`600`},children:D.toLocaleString(`en-IN`,{minimumFractionDigits:2,maximumFractionDigits:2})})]}),(0,p.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,padding:`3px 8px`,borderBottom:`1px solid #000`,fontStyle:`italic`,fontSize:`12px`},children:[(0,p.jsxs)(`span`,{children:[`SGST @ `,w,`%`]}),(0,p.jsx)(`span`,{style:{fontWeight:`600`},children:O.toLocaleString(`en-IN`,{minimumFractionDigits:2,maximumFractionDigits:2})})]})]}):(0,p.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,padding:`4px 8px`,borderBottom:`1px solid #000`,fontStyle:`italic`,fontSize:`12px`},children:[(0,p.jsxs)(`span`,{children:[`IGST @ `,C,`%`]}),(0,p.jsx)(`span`,{style:{fontWeight:`600`},children:k.toLocaleString(`en-IN`,{minimumFractionDigits:2,maximumFractionDigits:2})})]}),(0,p.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,padding:`4px 8px`,fontWeight:`bold`,fontSize:`12.5px`},children:[(0,p.jsx)(`span`,{children:`GROSS AMOUNT`}),(0,p.jsxs)(`span`,{children:[`Rs. `,A.toLocaleString(`en-IN`,{minimumFractionDigits:2,maximumFractionDigits:2})]})]})]})]}),(0,p.jsxs)(`div`,{style:{display:`flex`,fontSize:`11.5px`,minHeight:`85px`},children:[(0,p.jsx)(`div`,{style:{width:`15%`,borderRight:`1px solid #000`,display:`flex`,alignItems:`center`,justifyContent:`center`,padding:`4px`},children:(0,p.jsx)(`u`,{style:{fontWeight:`bold`,fontSize:`12px`},children:`E & O.E`})}),(0,p.jsxs)(`div`,{style:{width:`45%`,borderRight:`1px solid #000`,padding:`4px 8px`,lineHeight:`1.4`},children:[(0,p.jsx)(`div`,{style:{fontWeight:`bold`,textDecoration:`underline`,marginBottom:`2px`,fontSize:`12px`},children:`Bank Account Details`}),(0,p.jsxs)(`div`,{style:{display:`flex`},children:[(0,p.jsx)(`span`,{style:{width:`85px`,fontWeight:`500`},children:`Bank Name`}),(0,p.jsxs)(`span`,{children:[`: `,g?.bankName||`Bank of India`]})]}),(0,p.jsxs)(`div`,{style:{display:`flex`},children:[(0,p.jsx)(`span`,{style:{width:`85px`,fontWeight:`500`},children:`Account No.`}),(0,p.jsxs)(`span`,{children:[`: `,(0,p.jsx)(`strong`,{children:g?.accountNumber||`811030100000006`})]})]}),(0,p.jsxs)(`div`,{style:{display:`flex`},children:[(0,p.jsx)(`span`,{style:{width:`85px`,fontWeight:`500`},children:`Branch`}),(0,p.jsxs)(`span`,{children:[`: `,g?.branch||`Karaikal`]})]}),(0,p.jsxs)(`div`,{style:{display:`flex`},children:[(0,p.jsx)(`span`,{style:{width:`85px`,fontWeight:`500`},children:`IFSC`}),(0,p.jsxs)(`span`,{children:[`: `,(0,p.jsx)(`strong`,{children:g?.ifscCode||`BKID0008110`})]})]})]}),(0,p.jsxs)(`div`,{style:{width:`40%`,padding:`4px 10px`,display:`flex`,flexDirection:`column`,justifyContent:`space-between`,textAlign:`right`},children:[(0,p.jsxs)(`div`,{style:{fontSize:`12px`},children:[`For `,(0,p.jsx)(`strong`,{children:g?.companyName||`SRI DURGA ENTERPRISES`})]}),(0,p.jsx)(`div`,{style:{fontStyle:`italic`,fontSize:`11px`,textAlign:`right`},children:`Authorised Signatory`})]})]})]})]},`${t}-${r}`)})},t))})}),(0,p.jsxs)(`div`,{style:{padding:`0.75rem 1.25rem`,background:`rgba(15, 23, 42, 0.98)`,borderTop:`1px solid rgba(255, 255, 255, 0.1)`,display:`flex`,alignItems:`center`,justifyContent:`space-between`,flexWrap:`wrap`,gap:`0.75rem`,flexShrink:0},children:[(0,p.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`0.4rem`},children:[(0,p.jsx)(`span`,{style:{fontSize:`0.75rem`,color:`#94a3b8`,fontWeight:800,textTransform:`uppercase`,marginRight:`0.2rem`},children:`COPY:`}),[{id:`ORIGINAL`,label:`Original`},{id:`DUPLICATE`,label:`Duplicate`},{id:`OFFICE COPY`,label:`Office Copy`},{id:`ALL`,label:`All 3 Copies`}].map(e=>(0,p.jsx)(`button`,{onClick:()=>u(e.id),className:`btn btn-outline`,style:{fontSize:`0.78rem`,padding:`0.35rem 0.75rem`,borderRadius:`6px`,border:l===e.id?`1px solid #38bdf8`:`1px solid rgba(255, 255, 255, 0.12)`,background:l===e.id?`rgba(56, 189, 248, 0.2)`:`rgba(255, 255, 255, 0.04)`,color:l===e.id?`#38bdf8`:`#cbd5e1`,fontWeight:l===e.id?800:500},children:e.label},e.id))]}),(0,p.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`0.5rem`},children:(0,p.jsxs)(`label`,{style:{display:`inline-flex`,alignItems:`center`,gap:`0.45rem`,background:d?`rgba(56, 189, 248, 0.2)`:`rgba(255, 255, 255, 0.04)`,border:d?`1.5px solid #38bdf8`:`1px solid rgba(255, 255, 255, 0.12)`,padding:`0.35rem 0.85rem`,borderRadius:`6px`,cursor:`pointer`,userSelect:`none`,transition:`all 0.2s ease`},title:`Toggle to Show or Hide Item Number column in Proforma Invoice printout`,children:[(0,p.jsx)(`input`,{type:`checkbox`,checked:d,onChange:e=>{h(e.target.checked),localStorage.setItem(`sri_durga_print_show_item_number`,String(e.target.checked))},style:{width:`15px`,height:`15px`,accentColor:`#0284c7`,cursor:`pointer`}}),(0,p.jsx)(`span`,{style:{fontSize:`0.8rem`,fontWeight:700,color:d?`#38bdf8`:`#cbd5e1`},children:`Item Number`})]})}),(0,p.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`0.625rem`},children:[(0,p.jsx)(`button`,{onClick:r,className:`btn btn-outline`,style:{fontSize:`0.85rem`,padding:`0.5rem 1rem`},children:`Close`}),(0,p.jsxs)(`button`,{onClick:v,className:`btn btn-primary`,style:{fontSize:`0.85rem`,padding:`0.5rem 1.25rem`,display:`flex`,alignItems:`center`,gap:`0.5rem`,background:`linear-gradient(135deg, #0284c7 0%, #0369a1 100%)`,boxShadow:`0 4px 14px rgba(2, 132, 199, 0.4)`},children:[(0,p.jsx)(n,{size:16}),(0,p.jsx)(`span`,{children:`Print Invoice / Save PDF`})]})]})]})]})]})};export{d as n,h as t};