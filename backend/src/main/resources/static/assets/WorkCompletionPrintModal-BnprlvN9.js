import{t as e}from"./file-text-CH7PaY1Y.js";import{t}from"./printer-iHWfwa3S.js";import{Dt as n,Et as r,k as i,n as a}from"./index-DG215SlJ.js";var o=n(r()),s=i(),c=({isOpen:n,onClose:r,certificate:i})=>{let[c,l]=(0,o.useState)(`both`);if((0,o.useEffect)(()=>{let e=e=>{e.key===`Escape`&&r()};return n&&window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[n,r]),!n||!i)return null;let u=i.equipmentDescription===`Service`,d=(i.items||[]).filter(e=>e.itemType===`SERVICE`),f=(i.items||[]).filter(e=>e.itemType===`MATERIAL`||!e.itemType),p=()=>{let e=document.getElementById(`work-cert-print-area`);if(!e){window.print();return}let t=window.open(``,`_blank`,`width=900,height=1050`);if(t){let n=e.innerHTML;t.document.write(`
        <!DOCTYPE html>
        <html>
          <head>
