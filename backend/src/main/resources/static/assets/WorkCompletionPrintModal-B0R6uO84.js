import{o as e}from"./rolldown-runtime-C0FnF6B9.js";import{t}from"./file-text-0Som5JEN.js";import{t as n}from"./printer-C3ZMhxVi.js";import{P as r,Pt as i,n as a}from"./index-COMoAmjp.js";var o=e(i()),s=r(),c=({isOpen:e,onClose:r,certificate:i})=>{let[c,l]=(0,o.useState)(`both`);if((0,o.useEffect)(()=>{let t=e=>{e.key===`Escape`&&r()};return e&&window.addEventListener(`keydown`,t),()=>window.removeEventListener(`keydown`,t)},[e,r]),!e||!i)return null;let u=(i.equipmentDescription||``).toLowerCase().includes(`service`)||(i.items||[]).some(e=>e.itemType===`SERVICE`),d=(i.items||[]).filter(e=>e.itemType===`SERVICE`),f=(i.items||[]).filter(e=>e.itemType===`MATERIAL`||!e.itemType),p=()=>{let e=document.getElementById(`work-cert-print-area`);if(!e){window.print();return}let t=window.open(``,`_blank`,`width=900,height=1050`);if(t){let n=e.innerHTML;t.document.write(`
        <!DOCTYPE html>
        <html>
          <head>
